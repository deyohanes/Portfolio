...
import {AiFillTwitterCircle, AiFillLinkedin, AiOutlinePhone ,} from 'react-icons/ai'
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">YD</h1>
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-96 md:w-96">
              <Image src={deved} alt="yohanes" layout="fill" objectFit="cover" />
            </div>
          </div>
        </section>
        <section>
          ...
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              <Image src={consulting} alt="consulting image" width={100} height={100} />
              <h3 className="text-lg font-medium pt-8 pb-2 ">Consulting</h3>
              <p className="py-2">
                Are you interested in feedback for your current project? I can
                give you tips and tricks to level it up.
              </p>
              <h4 className="py-4 text-teal-600">Ask Me on</h4>
              <p className="text-gray-800 py-1">UI Design</p>
              <p className="text-gray-800 py-1">Database Design</p>
              <p className="text-gray-800 py-1">Software Development</p>
             </div>
          </div>
        </section>
